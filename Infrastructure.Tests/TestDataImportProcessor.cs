...
namespace Infrastructure.Tests
{
	...
	public class TestDataImportProcessor
	{
		...
		public void ImportModelsFromCsv_SingleCreatorEmployeeEmployer_ParsesCorrectly()
		{
			...
			Assert.That(employee.DateOfBirth, Is.EqualTo(new DateTime(1980, 01, 01)));
			...
			Assert.That(employee.BankAccountType, Is.EqualTo("1"));
		...
		[Test]
		public void ImportModelsFromCsv_SingleCreatorEmployeeEmployer_ParsesCorrectlyX()
		{
			var csvLines = new[]
			{
                // Creator
                "8000,\"UICR\",8010,\"U1\",8015,\"E03\",8020,\"123456789\",8030,\"LIVE\",8040,\"John Doe\",8050,\"0123456789\",8060,\"john@example.com\",8070,202406",
                // Employee
                "8001,\"UIWK\",8110,\"987654321\",8200,8001015009087,8230,\"Smith\",8240,\"Jane\",8250,19800101,8300,1234.56,8310,1200.00,8320,12.34,8330,123456,8340,1234567890,8350,1",
                // Employer
                "8002,\"UIEM\",8115,\"111222333\",8120,1234567890,8130,1234.56,8135,1200.00,8140,12.34,8150,1,8160,\"employer@example.com\""
			};
